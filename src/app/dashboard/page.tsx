...
export default function DashboardPage() {
    ...
    const handlePortfolioTypeChange = (type: "DEMO" | "REAL") => {
    ...
    return (
        <div className="flex min-h-screen w-full flex-col">
            <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Button
                            ...
                            onClick={() => handlePortfolioTypeChange("DEMO")}
                            className="gap-2"
                        >
                        ...
                        <Button
                            ...
                            onClick={() => handlePortfolioTypeChange("REAL")}
                            className="gap-2"
                        >
                        ...
                        <div className="mt-4 flex w-full items-center justify-center">
                            <Card className="w-full border-dashed bg-muted/50">
                                <CardContent className="flex flex-col items-center justify-center p-6">
                                    ...
                                    <h3 className="mb-2 text-xl font-medium">Connect Your Brokerage Account</h3>
                ...
                <PortfolioSwitcher portfolioType={portfolioType} />
