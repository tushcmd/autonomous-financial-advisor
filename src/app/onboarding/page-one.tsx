                            ...
                            >
                                {goalOptions.map((goal) => (
                                    <div key={goal.id}>
                                        ...
                                        <Label
                                            htmlFor={goal.id}
                                            className={`flex flex-col items-center justify-between rounded-md border-2 ${selectedGoal === goal.id ? "border-primary" : "border-muted"
                                                } bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary cursor-pointer h-full`}
                                        >
